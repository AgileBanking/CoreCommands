...
class gsp_coreCommands_layoutsmain_gsp extends GroovyPage {
...
printHtmlPart(3)
expressionOut.print(resource(dir: 'images', file: 'AgileBanking-icon.png'))
printHtmlPart(4)
expressionOut.print(resource(dir: 'images', file: 'AgileBanking114X114.png'))
printHtmlPart(5)
...
public static final long LAST_MODIFIED = 1354957470000L
