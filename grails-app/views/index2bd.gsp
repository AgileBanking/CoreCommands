	...
	<body>
		...
		<div id="page-body" role="main">
			<h1>Welcome to  Agile Banking</h1>
                        <h2>Component: CORE UPDATES LAYER</h2>
			<p>This is the Core Updates layer of the 'Agile Banking', the responsible for New and Updates. You can access all Core Components as GET REST services:</p>
